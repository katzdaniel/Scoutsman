...
with open(search_term+'_prices.csv', 'w', newline='') as file:
    try:
        fieldnames = ['name', 'price', 'num_reviews', 'per_cnt_price', 'url', 'timestamp']
        ...
        for i in range(10):
            ...
            for product in products:
                ...
                product_dict['timestamp'] = str(datetime.now()).split('.')[0]
